...
No adapter passes v2 yet. TypeScript 1.x continues to pass v1. Cross-runtime v2
compatibility may be claimed only after both the TypeScript 2.x and C# adapters pass
the inherited and v2 cases through their public runtime seams.
