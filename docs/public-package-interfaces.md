...
| Maintained Creator-adapter requirements | `PageElementDecoratorProvider`, `PageElementSlot`, `QuestionErrors`, `QuestionTitleContent`, `questionErrorId`, `questionId`, `useIdScope`, `QuestionRenderersProvider`, `readOnlyAction`, `reorderAnnouncement` | Creator adorners, nested container rendering, property actions, and placement narration import these through the public package seam. |
