...
namespace Kajay.Workflow.Host.Persistence.Migrations
{
    ...
    [Migration("20260807165310_AddHumanReview")]
    partial class AddHumanReview
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kajay.Workflow.Host.Persistence.ReviewTaskRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("AssignedPermission")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");
                    ...
                    b.HasIndex("TenantId", "AssignedPermission", "Status", "CreatedAt");

                    b.HasIndex("TenantId", "WorkflowInstanceId", "StepKey", "RoundNumber")
                        .IsUnique();
            ...
            modelBuilder.Entity("Kajay.Workflow.Host.Persistence.SurveySubmissionRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "WorkflowInstanceId", "StepKey", "AttemptNumber")
                        .IsUnique();
            ...
            modelBuilder.Entity("Kajay.Workflow.Host.Persistence.ReviewTaskRecord", b =>
                {
                    b.HasOne("Kajay.Workflow.Host.Persistence.SurveySubmissionRecord", null)
                        .WithMany()
