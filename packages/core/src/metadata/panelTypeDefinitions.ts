...
export const PANEL_TYPE_DEFINITIONS: PanelTypeDefinitions = {
  panelDynamic: {
    ...
    properties: [
      ...
      { name: 'addPanelText', type: 'string', defaultValue: 'Add another' },
      { name: 'removePanelText', type: 'string', defaultValue: 'Remove' },
      {
        name: 'confirmDelete',
        type: 'boolean',
        description: 'Removing an instance asks first. A panel can hold a lot of typing.',
      },
      { name: 'confirmDeleteText', type: 'string', defaultValue: 'Remove this one?' },
      {
