...
/** Multi-select. The answer is an array, empty rather than absent once touched. */
export class CheckboxQuestion extends SelectQuestion {
  ...
  get isAllSelected(): boolean {
    ...
    return (
      selectable.length > 0 && selectable.every((choiceValue) => this.isSelected(choiceValue))
    );
  }
