 ...
 *
 * A factory beside `createSurveyLogic` because the interesting part is the *ordering* —
 * the page clock restarts before anyone is told the page changed, so a listener that
 * reads the timer sees the new page's allowance rather than the old page's remainder.
 */
