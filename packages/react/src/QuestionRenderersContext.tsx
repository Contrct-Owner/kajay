...
const QuestionRenderersContext =
  createContext<QuestionRendererRegistry>(defaultQuestionRenderers);
...
export function useQuestionRenderers(): QuestionRendererRegistry {
  return useContext(QuestionRenderersContext);
}
